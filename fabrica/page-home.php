...
Description: Template da pagina home
*/
get_header();?>
<main id="home">
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="thumb-slider">
                  <img src="<?php echo get_template_directory_uri(); ?>/img/kids-complete.png" alt="">
                </div>
              </div>
            </div>
          </div>
  ...
  <!-- PRIMEIRA SESSÃO -->
  <section class="garantia transition-before transition-white">
    <img src="<?php echo get_template_directory_uri(); ?>/img/ballon.png" alt="" class="ballon-image" />
    <div class="container">
      <div class="row">
        <div class="content">
          <h2 class="title-bar">
            <?php 
              echo (get_theme_mod('set_garantia_title')) ?
              get_theme_mod('set_garantia_title') : 
              ('Tornamos seu evento  inesquecível');
            ?>
          </h2>
          <p class="text-bold">
            <?php 
              echo (get_theme_mod('set_garantia_text')) ?
              nl2br(get_theme_mod('set_garantia_text')) : 
          ...
          <p class="text-bold">
            ...
            <a <?php 
              echo (get_theme_mod('set_garantia_btn')) ?
              ('style="display: inherit;"') : 
              ('style="display: none;"');
            ?>href="#" class="btn btn-orange"> Nossa recreação infantil</a>
        </div>
        <div class="video">
          <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-video.png" alt="" />
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="boxes">
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <div class="content">
  ...
  <section class="equipe transition-before transition-white">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="swiper-group-content">
                  <img src="<?php echo get_template_directory_uri(); ?>/img/icon-ballon-stars.png" alt=""
                    class="icon" />
                  <strong>+7500</strong>
  ...
  <section class="diferenciais transition-after transition-light-blue">
    <div class="container">
      <div class="row">
        ...
        <div class="boxes">
          <div class="box">
            <img src="<?php echo get_template_directory_uri(); ?>/img/icon-rounded-kids.png" alt="" class="icon" />
          ...
          <div class="box">
            <img src="<?php echo get_template_directory_uri(); ?>/img/icon-rounded-shield.png" alt="" class="icon" />
          ...
          <div class="box">
            <img src="<?php echo get_template_directory_uri(); ?>/img/icon-rounded-confetti.png" alt="" class="icon" />
  ...
  <section class="turbinar">
    <div class="container">
      <div class="row">
        ...
        <h3 class="subtitle">
          Eleve seu evento infantil a um outro nível com nossos serviços
          especiais, proporcionando momentos que ficarão gravados na memória de todos.
        </h3>
        <div class="boxes">
          <div class="box">
            <div class="thumb">
            ...
            <h4 class="title-box">Oficinas</h4>
          </div>
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <h4 class="title-box">Escultura de balão</h4>
          </div>
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <h4 class="title-box">Pintura Facial</h4>
          </div>
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <h4 class="title-box">Camarim Fashion</h4>
          </div>
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <h4 class="title-box">Show de mágico</h4>
          </div>
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <h4 class="title-box">Teatro Lúdico</h4>
          </div>
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <h4 class="title-box">Combate Nerf</h4>
          </div>
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <h4 class="title-box">Festa do Pijama</h4>
          </div>
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <h4 class="title-box">Personagens</h4>
          </div>
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <h4 class="title-box">Kids & Teen Disco</h4>
          </div>
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <h4 class="title-box">Acampamento</h4>
          </div>
          <div class="box">
            <div class="thumb">
              <img src="<?php echo get_template_directory_uri(); ?>/img/thumb-post.png" alt="" />
            </div>
            <h4 class="title-box">Brinquedos Infláveis</h4>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="content">
          ...
          <a href="#" class="btn btn-orange">
            <img src="<?php echo get_template_directory_uri(); ?>/img/icon-whatsapp.png" alt="" />Entre em contato</a>
        </div>
        <div class="image">
    ...
    <div class="container">
      <div class="row">
        <div class="content">
          ...
          <a href="#" class="btn btn-orange"> Comece já! </a>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="tabs">
            <div class="tab tab-gender" id="tab-gender">
              <div class="tab-container">
                ...
                <div class="boxes">
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/illustration-girl.png" alt=""
                      class="icon-kid" />
                    <button class="btn btn-unique btn-select" type="button">Menina</button>
                  </div>
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/illustration-boy.png" alt=""
                      class="icon-kid" />
            ...
            <div class="tab" id="tab-guests">
              ...
              <div class="tab-container">
                ...
                <div class="boxes">
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/kids-group.png" alt=""
                      class="icon-kids-group" />
            ...
            <div class="tab" id="tab-gender-male">
              ...
              <div class="tab-container">
                ...
                <div class="boxes">
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/male-baby.png" alt=""
                      class="icon-kid-growing" />
                    <button class="btn btn-unique btn-select" type="button">0 a 2 anos</button>
                  </div>
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/male-kid.png" alt=""
                      class="icon-kid-growing" />
                    <button class="btn btn-unique btn-select" type="button">3 a 5 anos</button>
                  </div>
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/male-preteen.png" alt=""
                      class="icon-kid-growing" />
                    <button class="btn btn-unique btn-select" type="button">6 a 8 anos</button>
                  </div>
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/male-teenager.png" alt=""
                      class="icon-kid-growing" />
                    <button class="btn btn-unique btn-select" type="button">9 a 12 anos</button>
                  </div>
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/male-preadult.png" alt=""
                      class="icon-kid-growing" />
            ...
            <div class="tab" id="tab-gender-female">
              ...
              <div class="tab-container">
                ...
                <div class="boxes">
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/female-baby.png" alt=""
                      class="icon-kid-growing" />
                    <button class="btn btn-unique btn-select" type="button">0 a 2 anos</button>
                  </div>
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/female-kid.png" alt=""
                      class="icon-kid-growing" />
                    <button class="btn btn-unique btn-select" type="button">3 a 5 anos</button>
                  </div>
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/female-preteen.png" alt=""
                      class="icon-kid-growing" />
                    <button class="btn btn-unique btn-select" type="button">6 a 8 anos</button>
                  </div>
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/female-teenager.png" alt=""
                      class="icon-kid-growing" />
                    <button class="btn btn-unique btn-select" type="button">9 a 12 anos</button>
                  </div>
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/female-preadult.png" alt=""
                      class="icon-kid-growing" />
                    <button class="btn btn-unique btn-select" type="button">13 a 15 anos</button>
                  </div>
                </div>
            ...
            <div class="tab" id="tab-where">
              ...
              <div class="tab-container">
                ...
                <div class="boxes">
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/buildings-2.png" alt=""
                      class="icon-city" />
            ...
            <div class="tab" id="tab-theme">
              ...
              <div class="tab-container">
                ...
                <div class="boxes">
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/kids-group-2.png" alt=""
                      class="icon-kids-group-2" />
                    <div class="box-buttons">
            ...
            <div class="tab" id="tab-more-options">
              ...
              <div class="tab-container">
                ...
                <div class="boxes">
                  <div class="box">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/kids-group-3.png" alt=""
                      class="icon-kids-group-3" />
                    <div class="box-buttons">
              ...
              <div class="tab-container">
                ...
                <div class="boxes">
                  ...
                  <div class="box">
                    ...
                    <button type="button" class="btn btn-blue btn-send-event-form"
                      onclick="initConstructEmail()">Enviar</button>
                  </div>
                </div>
              </div>
            </div>
